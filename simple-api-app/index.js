...
app.get('/test', (req, res) => { // handle GET requests at '/test'
...
app.post('/test', (req, res) => { // handle POST requests at '/test'
    res.status(200)
        .setHeader('content-type', 'application/json')
        .send({message: 'Testing POST method'});
});

app.put('/test', (req, res) => { // handle PUT requests at '/test'
    res.status(200)
        .setHeader('content-type', 'application/json')
        .send({message: 'Testing PUT method'});
});

app.delete('/test', (req, res) => { // handle DELETE requests at '/test'
    res.status(200)
        .setHeader('content-type', 'application/json')
